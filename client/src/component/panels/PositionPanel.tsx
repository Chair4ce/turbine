...
const PositionPanel: React.FC<Props> = props => {
    ...
    const handlePanelClose = () => {
        props.callback(ROSTER_MENU_SELECT_ACTION.TOGGLE_POSITION_PANEL)
    }
    ...
    return (
        ...
        <div className={'panel'}>
            <React.Fragment>
                ...
                >
                    <DialogTitle id="max-width-dialog-title">Upload Positions (UPMR)</DialogTitle>
                    <DialogContent>
                        <DialogContentText>
...
export const StyledPositionPanel = styled(PositionPanel)`
