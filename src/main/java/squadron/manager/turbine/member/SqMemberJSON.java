...
public class SqMemberJSON {
    ...
    public SqMemberJSON(Long id, String ssan, String full_name, String grade, String assigned_pas, String dafsc, String office_symbol, String duty_title, Date duty_start_date, String duty_phone, String supv_name, Date supv_begin_date, Date date_arrived_station, Date dor) {
        this.id = id;
        this.ssan = ssan;
