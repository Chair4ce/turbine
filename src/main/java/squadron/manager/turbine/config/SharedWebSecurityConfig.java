...
public class SharedWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/members", "/api/members/*").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/api/members", "/api/members/*").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/api/members", "/api/members/*").hasAnyRole("ADMIN")
                .anyRequest()
                .authenticated()
                .and()
                .headers()
